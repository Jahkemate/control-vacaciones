...
<head>
    <meta charset="utf-8">
    <title>Solicitud de Pago de Días</title>
...
<body>
    ...
    {{-- HEADER --}}
    <div class="header">
        <h2>SOLICITUD DE PAGO DE DÍAS</h2>
    </div>
    ...
    <div class="section">
        ...
        <div class="section-content">
            ...
            <div class="row">
                ...
                <div class="value">
                    {{ $record->updated_at ?? 'No disponible' }}
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="value">
                    {{ $record->request_date ?? 'No disponible' }}
                </div>
            </div>
    ...
    {{-- FECHAS --}}
    <div class="section">
        <div class="section-title">Fechas de Compensación por Pago</div>
    ...
    <div class="section">
        ...
        <div class="section-content">
            ...
            <div class="row">
                <div class="label">Dias Totales a Pagar:</div>
                <div class="value">
                    {{ $record->paid_total ?? '0' }}
                </div>
            </div>
